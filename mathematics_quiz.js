...
import { questions as allQuestions } from './mathematics_questions.js';
...
onAuthStateChanged(auth, (user) => {
    if (user) {
        ...
        document.getElementById('quiz-title').textContent = `Mathematics Quiz (${difficulty})`;
